...
export default function SingleServiceCard({ service }: { service: ServiceType }) {
    const t = useTranslations();
    const { id, icon, services } = service;
    return (
        <motion.div className={`card ${css.service_card}`} {...animation} custom={id + 1.5} variants={blockAnimation}>
